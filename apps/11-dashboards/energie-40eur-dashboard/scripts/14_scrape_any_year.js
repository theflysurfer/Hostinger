/**
 * Script 14: Generic Year Scraper for ENTSO-E
 * Usage: node scripts/14_scrape_any_year.js 2023
 */
...
async function main() {
    ...
    console.log(`ENTSO-E ${year} SCRAPER`);
    console.log('='.repeat(80));

    const outputFile = path.join(__dirname, '..', 'data', 'raw', `entsoe_${year}_scraped.jsonl`);
    ...
    console.log('\n' + '='.repeat(80));
    console.log(`${year} SCRAPING COMPLETE!`);
    console.log('='.repeat(80));
