...
**Timeout d'inactivité** : `900` secondes (15 minutes)
**Services configurés** : 23
**État** : ✅ Fonctionnel (fix 24/10/2025)
...
- **Guide complet** : [GUIDE_DOCKER_AUTOSTART.md](../../guides/deployment/docker-autostart-setup.md)
...
### Fix Auto-Stop avec Dashy (24/10/2025)

**Problème :** L'auto-stop ne fonctionnait pas car Dashy générait des requêtes `axios/1.12.0` toutes les minutes, réinitialisant le compteur d'inactivité.

**Solution :**
1. Suppression complète des `statusCheck` dans Dashy (pas `false`, SUPPRIMÉ)
2. Dashy exclu de la configuration auto-stop (reste toujours actif)
3. Désactivation du service conflictuel `nginx-auto-docker`

**Résultat :** Auto-stop fonctionnel, vérifié avec SolidarLink (arrêt après 8h d'inactivité, redémarrage en 9s).

**Référence :** [Changelog complet](../../changelog/dashy-autostart-fix-2025-10-24.md)

---

**Dernière synchronisation** : 2025-10-24
**Config serveur** : `/opt/docker-autostart/config.json`
**Total services** : 23 (Dashy exclu de l'auto-stop)
